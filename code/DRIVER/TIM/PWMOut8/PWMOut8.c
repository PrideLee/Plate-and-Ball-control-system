...
//	TIM_OCI.TIM_OutputNState=
	...
	TIM_OCI.TIM_Pulse=(uint16_t)(10.0/100*g_Period_TIM1);
	TIM_OC1Init (TIM1,&TIM_OCI);
	
	TIM_OCI.TIM_Pulse=(uint16_t)(30.0/100*g_Period_TIM1);
	TIM_OC2Init (TIM1,&TIM_OCI);
	
	TIM_OCI.TIM_Pulse=(uint16_t)(50.0/100*g_Period_TIM1);
	TIM_OC3Init (TIM1,&TIM_OCI);
	
	TIM_OCI.TIM_Pulse=(uint16_t)(70.0/100*g_Period_TIM1);
...
//	TIM_OCI.TIM_OutputNState=
	TIM_OCI.TIM_OutputState=TIM_OutputState_Enable;
	TIM_OCI.TIM_Pulse=(uint16_t)(3.0/100*g_Period_TIM3);
	TIM_OC1Init (TIM3,&TIM_OCI);
	
	TIM_OCI.TIM_Pulse=(uint16_t)(30.0/100*g_Period_TIM3);
	TIM_OC2Init (TIM3,&TIM_OCI);
	
	TIM_OCI.TIM_Pulse=(uint16_t)(50.0/100*g_Period_TIM3);
	TIM_OC3Init (TIM3,&TIM_OCI);
	
	TIM_OCI.TIM_Pulse=(uint16_t)(97.0/100*g_Period_TIM3);
